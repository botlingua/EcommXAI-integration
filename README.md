...
- Contributing — note this repo is a **published mirror**: direct pushes to `main` are overwritten on
  the next publish, and a publish closes open PRs automatically. Read
  [`CONTRIBUTING.md`](CONTRIBUTING.md#this-repository-is-a-published-mirror) before you start.
